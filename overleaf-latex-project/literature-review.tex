...
\renewcommand{\shortauthors}{Pangseen et al.}
...
The MultiFIX model is based on the application of symbolic reasoning with 
...
\begin{itemize}
    ...
    as in MultiFIX, into the pre-training of foundation-level multimodal models.
\end{itemize}
