...
frameworks such as WISE, P2X, and MultiFIX~\cite{malafaia2025step} focus on improving reasoning 
...
relational structure. Frameworks like P2X make programs separate by making 
models clearly name subjects, relations, and objects. This turns general 
...
Also, the P2X model requires the use of separate program generators; 
therefore, it cannot be optimized end-to-end. It is not possible to handle 
the single point of failure during the parsing process.
